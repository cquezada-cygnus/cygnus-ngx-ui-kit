...
export class CygnusButtonComponent implements OnInit { // esto fue creado para reemplazar @apply de tailwind, ya la documentación de tailwind 4 recomienda no usar @apply y se dice que no funciona muy bien en angular.
  ...
  BTN_ACCENT: string = 'flex items-center justify-center text-primary-500 border border-primary-50 bg-primary-50 hover:bg-primary-100 focus:bg-primary-100 active:bg-primary-100 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none';
  ...
  BTN_ERROR: string = 'flex items-center justify-center transition-all border border-error-500 text-white bg-error-500 hover:bg-error-600 focus:bg-error-700 focus:ring-error-200 active:bg-error-700 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none';
