export const TW_CLASS = {
  ...
  SELECT_XS: 'placeholder:text-slate-400 dark:placeholder:text-slate-500 text-slate-700 dark:text-slate-50 border-slate-200 dark:border-slate-500 rounded-lg !py-1.5 focus:border-slate-400 dark:focus:border-slate-600 hover:border-slate-400 dark:hover:border-slate-600 shadow-xs focus:shadow-md',
