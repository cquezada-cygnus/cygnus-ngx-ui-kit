  ...
  addTailwindClasses(customClass: string): string {
    ...
    switch (customClass) {
      case 'btn':
        ...
        return this.TW_CLASS.BTN_A_SIMPLE;
      case 'btn-primary':
        this.btnIconColor = '#ffffff';
        return this.TW_CLASS.BTN_A_PRIMARY;
      case 'btn-secondary':
        this.btnIconColor = '#1d2939';
        return this.TW_CLASS.BTN_A_SECONDARY;
      case 'btn-accent':
        this.btnIconColor = '#2970ff';
        return this.TW_CLASS.BTN_A_ACCENT;
      case 'btn-success':
        this.btnIconColor = '#ffffff';
        return this.TW_CLASS.BTN_A_GREEN;
      case 'btn-warning':
        this.btnIconColor = '#ffffff';
        return this.TW_CLASS.BTN_A_YELLOW;
      case 'btn-error':
        this.btnIconColor = '#ffffff';
      ...
      case 'btn-disabled':
        ...
        return this.TW_CLASS.BTN_A_DISABLED;
      case 'btn-block':
