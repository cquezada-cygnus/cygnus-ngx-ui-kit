export const TW_CLASS = {
  ...
  BTN_SECONDARY: 'text-gray-700 bg-gray-25 border-gray-300 hover:bg-gray-100 hover:text-blue-600 hover:border-gray-300 focus:ring-gray-300',
  ...
  BTN_OUTLINED: 'bg-transparent border-blue-700 text-blue-700 hover:bg-blue-800 hover:text-blue-50 hover:shadow-md focus:ring-blue-300',
